...
const S = {
  ...
  tableNumberBig: { fontSize: 120, fontWeight: 900, color: "#1A1A1A", letterSpacing: "-0.02em", lineHeight: 1 },
  toGoNameBig: { fontSize: 100, fontWeight: 900, color: "#0369A1", letterSpacing: "-0.01em", lineHeight: 1.1 },
  ticketMeta: { marginTop: 4 },
  checkNoLabel: { fontSize: 9, fontWeight: 800, color: "#9B8B72", letterSpacing: "0.15em" },
  checkNoValue: { fontSize: 80, fontWeight: 900, color: "#BE202E", letterSpacing: "0.05em" },
  timerBig: { fontSize: 72, fontWeight: 900, marginTop: 4, letterSpacing: "-0.01em" },
  ...
  itemQty: { width: 120, fontSize: 100, fontWeight: 900, letterSpacing: "-0.02em" },
  itemName: { fontSize: 80, lineHeight: 1.2 },
  ...
  btnStart: { background: "#D97706", color: "#fff", border: "none", borderRadius: 6, padding: "30px 60px", fontSize: 48, fontWeight: 900, cursor: "pointer" },
  btnDone: { background: "#15803D", color: "#fff", border: "none", borderRadius: 6, padding: "30px 60px", fontSize: 48, fontWeight: 900, cursor: "pointer" },
